...
function writeGeoTIFF(pixelData, options) {
    const { width, height, bitsPerSample, sampleFormat, samplesPerPixel, photometricInterpretation, bounds, } = options;
    ...
    // GeoTIFF tags
    entries.push(createIfdEntry(TAG_MODEL_PIXEL_SCALE, TYPE_DOUBLE, [pixelWidth, pixelHeight, 0]));
